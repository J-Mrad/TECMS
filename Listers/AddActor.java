...
public class AddActor extends JFrame implements Adder{
	...
	private JLabel label4 = new JLabel("Rating: ");
	...
	public AddActor(Account A, MovieManagementLister MML, Movies M){
		...
		save.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
						...
						UsageLog.add("Actor creation failed");
		           		dispose();
		           		
				}
				 
				UsageLog.add(A.getUsername() + " has added a new Actor");
				UsageLog.add(a + " " + b + " " + c + " " + " " + d);
